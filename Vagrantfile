...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.provision "shell", path: "./scripts/bootstrap.sh", privileged: false, args: ENV['REPO']
  config.vm.provision "shell", path: "./scripts/run_jekyll.sh", privileged: false, args: ENV['REPO'], run: 'always'
